...
}catch (e32164){if((e32164 instanceof Error)){
var e = e32164;
return null;
} else {
throw e32164;
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__32165){
var map__32167 = p__32165;
var map__32167__$1 = ((cljs.core.seq_QMARK_.call(null,map__32167))?cljs.core.apply.call(null,cljs.core.hash_map,map__32167):map__32167);
var opts = map__32167__$1;
var build_id = cljs.core.get.call(null,map__32167__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
var websocket_url = cljs.core.get.call(null,map__32167__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var retried_count = cljs.core.get.call(null,map__32167__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var retry_count = cljs.core.get.call(null,map__32167__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
...
socket.onmessage = ((function (url,socket,WebSocket,temp__4124__auto__,map__32167,map__32167__$1,opts,build_id,websocket_url,retried_count,retry_count){
...
var and__18070__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__18070__auto__){
var and__18070__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__18070__auto____$1)){
var and__18070__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
...
});})(url,socket,WebSocket,temp__4124__auto__,map__32167,map__32167__$1,opts,build_id,websocket_url,retried_count,retry_count))
;

socket.onopen = ((function (url,socket,WebSocket,temp__4124__auto__,map__32167,map__32167__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__4124__auto__,map__32167,map__32167__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
var retried_count__$1 = (function (){var or__18082__auto__ = retried_count;
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__4124__auto__,map__32167,map__32167__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__4124__auto__,map__32167,map__32167__$1,opts,build_id,websocket_url,retried_count,retry_count))
,(function (){var x__18401__auto__ = (10000);
var y__18402__auto__ = ((2000) + ((500) * retried_count__$1));
...
socket.onerror = ((function (url,socket,WebSocket,temp__4124__auto__,map__32167,map__32167__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1430779898168